      ...
      <div className="migration-container container">
        ...
        <header className="section-header">
          ...
          <p className="section-description">
            Migrate UPExchange customers to suitable products and tiers
            (ReportMyUP Standard, Plus, or UPEnterprise) based on their usage
            and feature needs.
          </p>
        </header>
        ...
        <div className="strategy-cards">
          <article className="strategy-card">
            <div className="strategy-number" aria-hidden="true">
              1.
            </div>
            ...
            <ul className="strategy-list">
              ...
              <li>
                Designed seamless migration flow that minimized disruption and
          ...
          <article className="strategy-card">
            ...
            <ul className="strategy-list">
              <li>
                Identified most valued features through support tickets analysis
                and stakeholders interviews
              </li>
              <li>
                Extended notification to Pendo guides and banners to walk users
                through transition and inform product changes
              </li>
              <li>
                Rewrote product-centric marketing messages to focus on user
                benefits
              </li>
              <li>
                Positioned migration as "upgrade with benefits" rather than
                forced change
              </li>
            </ul>
          </article>
          ...
          <article className="strategy-card">
            ...
            <ul className="strategy-list">
              <li>
                Collaborated with Product and Marketing to add missing features
                blocking migration
              </li>
              <li>
          ...
          <div className="user-flow-card">
            <header className="user-flow-header">
              ...
              <p className="user-flow-description">
                My user flow design transformed customer's migration from 5
                steps to 1 click.
              </p>
            </header>
            <img
        ...
        <div className="design-deliverables">
          <article className="deliverable-card email-card">
            ...
            <div className="deliverable-content email-content">
              ...
              <p className="deliverable-description">
                My email design promoted the most valuable features to
                customers.
              </p>
            </div>
          </article>
          ...
          <article className="deliverable-card demo-card">
            ...
            <div className="demo-videos-container">
              <div
                className="demo-videos"
                role="group"
                aria-label="Feature demonstration videos"
              >
                <video
                  autoPlay
                  loop
                ...
                >
                  <source src={vidMigrationDemoModern} />
                </video>
                <video
                  autoPlay
                  loop
                ...
                >
                  <source src={vidMigrationDemoReport} />
                </video>
                <video
                  autoPlay
                  loop
                ...
                >
                  <source src={vidMigrationDemoBilling} />
                </video>
              </div>
            </div>
          </article>
        ...
        <ResultsCard>
          ...
          <ResultItem checkmarkPath={svgPaths.p11b4680}>
            Cleaned up 2,000+ inactive/unpaid accounts, preventing future
            revenue loss and database overhead
          </ResultItem>
          <ResultItem checkmarkPath={svgPaths.p11b4680}>
