import svgPaths from "./svg-6mr4vh9y4o";
...
function CatDoodle() {
  return (
    <div className="absolute h-[75.581px] left-[119px] top-[907px] w-[112.735px]" data-name="cat-doodle">
...
function AbstractCatDoodle() {
  return (
    <div className="h-[285.535px] relative shrink-0 w-[281.802px]" data-name="abstract-cat-doodle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 282 286">
...
function Frame1770() {
  return (
    <div className="absolute content-start flex flex-wrap gap-[19.2px] h-[800px] items-start left-[616px] overflow-clip top-[125px] w-[932px]">
      {[...Array(25).keys()].map((_, i) => (
        <AbstractCatDoodle key={i} />
      ))}
    </div>
  );
}
...
function DescriptionGroup() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[437px]" data-name="Description group">
      ...
      <PillGroup />
      <p className="css-bqxx5z font-['Source_Sans_Pro:Regular',_sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#09543d] text-[18px] tracking-[-0.5px] w-[min-content]">{`My design for Sovos' first ecommerce product sparked market expansion and became the design blueprint for their global ecommerce portfolio.`}</p>
      <Button1 />
    </div>
  );
}
...
function DescriptionGroup2() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[437px]" data-name="Description group">
      ...
      <PillGroup2 />
      <p className="css-bqxx5z font-['Source_Sans_Pro:Regular',_sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#09543d] text-[18px] tracking-[-0.5px] w-[min-content]">{`Design Sovos’ first AI product, Sovos Intelligence, to expand service offerings to help businesses grow in unprecedented speeds and privacy in mind. `}</p>
      <Button5 />
    </div>
  );
}
...
function Logo() {
  return (
    <div className="content-stretch flex font-['Sora:Bold',_sans-serif] font-bold gap-[2px] items-center leading-[normal] relative shrink-0 text-[#09543d] text-[20px] text-nowrap tracking-[-0.2px] uppercase whitespace-pre" data-name="Logo">
...
function NavBar() {
  return (
    <div className="absolute box-border content-stretch flex items-center justify-between left-0 px-[32px] py-[24px] top-0 w-[1440px]" data-name="Nav bar">
      <div className="absolute h-[72.858px] left-[-0.12px] top-0 w-[1440.15px]">
...
export default function Home() {
  return (
    <div className="bg-[#fffdf7] relative size-full" data-name="Home">
      <div className="absolute bg-[#fffdf7] h-[1024px] left-0 top-0 w-[1440px]" data-name="pure color" />
      <CatDoodle />
      <Frame1770 />
      <Frame1772 />
      <p className="absolute css-l3z3w9 font-['Sora:Light',_sans-serif] font-light leading-[normal] left-[313px] text-[#09543d] text-[16px] text-nowrap top-[725px] tracking-[-0.5px] whitespace-pre">I make things easier, even your tax</p>
      <div className="absolute flex h-[43px] items-center justify-center left-[197px] top-[694px] w-[104px]">
      ...
      <Frame1773 />
      <p className="absolute css-bqxx5z font-['Source_Sans_Pro:Regular',_sans-serif] leading-[normal] left-[calc(50%-328px)] not-italic text-[#09543d] text-[18px] text-nowrap top-[3292px] tracking-[-0.5px] whitespace-pre">{`❤️ Designed and built by Dan to share the joy of creativity & show off works that she’s proud of`}</p>
      <NavBar />
    </div>
  );
}