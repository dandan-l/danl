...
function Container() {
  return (
    <div
      className="content-stretch flex flex-col md:flex-row font-['Source_Sans_Pro:Regular',sans-serif] gap-[16px] md:gap-[40px] items-start justify-center not-italic relative shrink-0 text-[#51596d] text-[18px] text-nowrap tracking-[-0.5px] whitespace-pre"
      data-name="Container"
    >
...
function Container1() {
  return (
    <div
      className="content-stretch flex flex-col gap-[16px] items-start leading-[normal] relative shrink-0 w-full"
      data-name="Container"
    >
      <Container />
      <p className="font-['Sora:SemiBold',sans-serif] font-semibold min-w-full relative shrink-0 text-[#2c2c2c] text-[32px] md:text-[40px] w-[min-content]">
...
function Container3() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-[4px] items-start justify-center px-[8px] py-[4px] relative rounded-[8px] shrink-0"
      data-name="Container"
    >
      <Container2 />
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] text-nowrap tracking-[-0.5px] whitespace-pre">
        ARR Growth
      </p>
    </div>
  );
...
function Container4() {
  return (
    <div
      ...
      data-name="Container"
    >
      <p className="font-['Sora:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#2c2c2c] text-[20px] md:text-[24px] text-nowrap tracking-[-0.5px] whitespace-pre">
        44%
      </p>
      <div
        className="overflow-clip relative shrink-0 size-[24px]"
...
function Container10() {
  return (
    <div
      className="content-stretch flex flex-wrap md:flex-nowrap items-start justify-between gap-[16px] md:gap-[24px] relative shrink-0 w-full"
      data-name="Container"
    >
      <Container3 />
      <Container5 />
...
function HeaderTextContainer() {
  return (
    <div
      className="relative content-stretch flex flex-col gap-[24px] md:gap-[32px] items-start justify-center px-4 md:px-8 lg:px-16 py-8 md:py-16 w-full max-w-[507px] mx-auto"
...
function Header() {
  return (
    <div
      className="bg-[#f0fbfb] min-h-[600px] md:h-[960px] overflow-clip relative shrink-0 w-full"
      data-name="header"
    >
      <div
        className="absolute bottom-0 h-full left-0 w-full"
        data-name="HeaderBGImg"
      >
        <img
          alt=""
...
function RolesContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[8px] items-start leading-[normal] relative shrink-0 text-[16px] md:text-[18px] text-nowrap tracking-[-0.5px] w-full md:w-[157px] whitespace-pre"
      data-name="Roles container"
    >
      <p className="font-['Sora:Light',sans-serif] font-light relative shrink-0 text-[#51596d]">
        👩🏻‍💻 Roles
      </p>
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] not-italic relative shrink-0 text-[#2c2c2c]">
...
function TimelineDetailsContainer() {
  return (
    <div
      className="content-stretch flex flex-col font-['Source_Sans_Pro:Regular',sans-serif] gap-[8px] items-start leading-[normal] not-italic relative shrink-0 text-[#2c2c2c] text-[16px] md:text-[18px] text-nowrap tracking-[-0.5px] whitespace-pre"
      data-name="Timeline details container"
    >
...
function TimelineContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full md:w-auto"
      data-name="Timeline container"
    >
      <p className="font-['Sora:Light',sans-serif] font-light leading-[normal] relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] text-nowrap tracking-[-0.5px] whitespace-pre">
        ⏳ Timeline
      </p>
...
function CollaboratorsDetailsContainer() {
  return (
    <div
      className="content-start flex flex-wrap font-['Source_Sans_Pro:Regular',sans-serif] gap-[8px] items-start leading-[normal] not-italic relative shrink-0 text-[#2c2c2c] text-[16px] md:text-[18px] text-nowrap tracking-[-0.5px] w-full whitespace-pre"
      data-name="Collaborators details container"
    >
...
function CollaboratorsContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full md:w-[477px]"
      data-name="Collaborators container"
    >
      <p className="font-['Sora:Light',sans-serif] font-light leading-[normal] relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] text-nowrap tracking-[-0.5px] whitespace-pre">
        🤘🏻 Collaborators
      </p>
...
function HeaderContainer() {
  return (
    <div
      className="content-stretch flex flex-col md:flex-row gap-[24px] md:gap-[40px] items-start justify-between w-full max-w-[1200px] relative rounded-[8px] shrink-0"
...
function ContextDetailsContainer() {
  return (
    <div
      ...
      data-name="Context details container"
    >
...
function ContextContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[16px] items-start w-full max-w-[1200px] relative shrink-0"
      data-name="Context container"
    >
      <p className="font-['Sora:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#2c2c2c] text-[24px] md:text-[32px] tracking-[-0.5px] w-full">
        Context
      </p>
      <InsightGroup />
    </div>
...
function SummaryDetailsContainer() {
  return (
    <div
      className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full"
      data-name="Summary details container"
    >
...
function JustinDetailsContainer() {
  return (
    <div
      className="bg-white box-border content-stretch flex flex-col gap-[4px] items-start pb-[16px] pl-[32px] pr-[24px] pt-[48px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0"
      data-name="Justin details container"
    >
      <p className="font-['Sora:Bold',sans-serif] font-bold leading-[28px] relative shrink-0 text-[#2c2c2c] text-[16px] md:text-[18px] text-nowrap tracking-[-0.2px] whitespace-pre">
        Justin
      </p>
        ...
        <ul className="list-disc ml-[-1.5em]">
          <li className="mb-0 ms-[27px]">
            <span className="leading-[normal]">
              Manages all business aspects and daily duties of running a barber
              shop
            </span>
          </li>
          <li className="mb-0 ms-[27px]">
      ...
      <div
        className="absolute h-[81px] left-[29.5px] top-[-40px] w-[68px]"
        data-name="JustinImage"
      >
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img
            alt=""
            className="absolute h-[148.61%] left-[-26.47%] max-w-none top-[-48.61%] w-[137.5%]"
            src={imgJustinImage}
          />
        </div>
      </div>
...
function JustinContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full md:w-auto"
      data-name="Justin container"
    >
      <JustinDetailsContainer />
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] text-center text-nowrap whitespace-pre">
...
function LeilaDetailsContainer() {
  return (
    <div
      className="bg-white box-border content-stretch flex flex-col gap-[4px] items-start pb-[16px] pl-[32px] pr-[24px] pt-[48px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0"
      data-name="Leila details container"
    >
      <p className="font-['Sora:Bold',sans-serif] font-bold leading-[28px] relative shrink-0 text-[#2c2c2c] text-[16px] md:text-[18px] text-nowrap tracking-[-0.2px] whitespace-pre">
        Leila
      </p>
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#017780] text-[16px] md:text-[18px] text-nowrap tracking-[-0.1px] whitespace-pre">
        Accountant @ DLC Accounting Services
      </p>
      <div className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] text-nowrap">
        <ul className="list-disc ml-[-1.5em]">
          <li className="mb-0 ms-[27px]">
      ...
      <div
        className="absolute h-[76px] left-[31.5px] top-[-35px] w-[68px]"
        data-name="LeilaImage"
      >
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img
            alt=""
            className="absolute h-[150.34%] left-0 max-w-none top-[-50.34%] w-[113.06%]"
            src={imgLeilaImage}
          />
        </div>
      </div>
...
function LeilaContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full md:w-auto"
      data-name="Leila container"
    >
      <LeilaDetailsContainer />
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] text-center text-nowrap whitespace-pre">
        Accountant (power user)
      </p>
    </div>
  );
}
...
function PersonaDetailsContainer() {
  return (
    <div
      className="content-stretch flex flex-col md:flex-row gap-[32px] md:gap-[40px] items-start justify-between relative shrink-0 w-full"
      data-name="Persona details container"
    >
      <JustinContainer />
      <LeilaContainer />
    </div>
...
function PersonaContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[40px] md:gap-[64px] items-start w-full max-w-[1200px] relative shrink-0"
      data-name="Persona container"
    >
      <p className="font-['Sora:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#2c2c2c] text-[24px] md:text-[32px] tracking-[-0.5px] w-full">
        Persona
      </p>
...
function TaxFeedback1Container() {
  return (
    <div
      className="basis-0 bg-white grow min-h-px min-w-[200px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0"
      data-name="Tax feedback 1 container"
    >
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start pb-[16px] pt-[48px] px-[24px] relative w-full">
          <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#017780] text-[16px] md:text-[18px] w-[min-content]">
          ...
          <div
            className="absolute left-[30.5px] size-[66.67px] top-[-26px]"
            data-name="MoneyFlyingAwayDecorativeImg"
          >
            <img
              alt=""
              className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full"
              src={imgMoneyFlyingAwayDecorativeImg}
            />
          </div>
        </div>
      </div>
...
function TaxFeedback2Container() {
  return (
    <div
      className="basis-0 bg-white grow min-h-px min-w-[200px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0"
      data-name="Tax feedback 2 container"
    >
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start pb-[16px] pt-[48px] px-[24px] relative w-full">
          <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#017780] text-[16px] md:text-[18px] text-nowrap whitespace-pre">
          ...
          <div
            className="absolute left-[30.17px] size-[66.67px] top-[-26px]"
            data-name="OldTapeDecorativeImg"
          >
            <img
              alt=""
              className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full"
              src={imgOldTapeDecorativeImg}
            />
          </div>
        </div>
      </div>
...
function TaxFeedback3Container() {
  return (
    <div
      className="basis-0 bg-white grow min-h-px min-w-[200px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0"
      data-name="Tax feedback 3 container"
    >
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start pb-[16px] pt-[48px] px-[24px] relative w-full">
          <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#017780] text-[16px] md:text-[18px] text-nowrap whitespace-pre">
          ...
          <div
            className="absolute left-[30.83px] size-[66.67px] top-[-26px]"
            data-name="AnnoyedFaceDecorativeImg"
          >
            <img
              alt=""
              className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full"
              src={imgAnnoyedFaceDecorativeImg}
            />
          </div>
        </div>
      </div>
...
function TaxFeedbackDetailsContainer() {
  return (
    <div
      className="content-stretch flex flex-col md:flex-row gap-[24px] md:gap-[40px] items-center relative shrink-0 w-full"
      data-name="Tax feedback details container"
    >
...
function TaxFeedbackContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[24px] md:gap-[40px] items-start w-full max-w-[1200px] relative shrink-0"
      data-name="Tax feedback container"
    >
      <p className="font-['Sora:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#2c2c2c] text-[24px] md:text-[32px] tracking-[-0.5px] w-full">
...
function EfmfFeedback1Container() {
  return (
    <div
      className="basis-0 bg-white grow min-h-px min-w-[200px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0"
      data-name="EFMF feedback 1 container"
    >
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start pb-[16px] pt-[48px] px-[24px] relative w-full">
          <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#017780] text-[16px] md:text-[18px] w-[min-content]">
          ...
          <div className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] w-[min-content]">
            <p className="leading-[normal]">
              Customers called support to guide them through the process. 20~30
              min phone calls disrupt the economics of small orders of 2~3 forms
              (~$14).
            </p>
          </div>
          <div
...
function EfmfFeedback2Container() {
  return (
    <div
      className="basis-0 bg-white grow min-h-px min-w-[200px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0"
      data-name="EFMF feedback 2 container"
    >
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start pb-[16px] pt-[48px] px-[24px] relative w-full">
          <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#017780] text-[16px] md:text-[18px] w-[min-content]">
          ...
          <div className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#51596d] text-[0px] w-[min-content]">
            <p className="leading-[normal] text-[16px] md:text-[18px]">
              ...
              <a
                ...
                target="_blank"
                className="[text-underline-position:from-font] decoration-solid font-['Source_Sans_Pro:Regular',sans-serif] not-italic underline"
              >
                Tax1099
              </a>
              .
          ...
          <div
            className="absolute left-[30.17px] size-[66.67px] top-[-26px]"
            data-name="LadderDecorativeImg"
          >
            <img
              alt=""
              className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full"
              src={imgLadderDecorativeImg}
            />
          </div>
        </div>
      </div>
...
function EfmfFeedback3Container() {
  return (
    <div
      className="basis-0 bg-white grow min-h-px min-w-[200px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0"
      data-name="EFMF feedback 3 container"
    >
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start pb-[16px] pt-[48px] px-[24px] relative w-full">
          <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#017780] text-[16px] md:text-[18px] w-[min-content]">
          ...
          <div
            className="absolute left-[30.83px] size-[66.67px] top-[-26px]"
            data-name="GrowthDecorativeImg"
          >
            <img
              alt=""
              className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full"
              src={imgGrowthDecorativeImg}
            />
          </div>
        </div>
      </div>
...
function EfmfFeedbackDetailsContainer() {
  return (
    <div
      className="content-stretch flex flex-col md:flex-row gap-[24px] md:gap-[40px] items-center relative shrink-0 w-full"
      data-name="EFMF feedback details container"
    >
...
function EfmfFeedbackContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[24px] md:gap-[40px] items-start w-full max-w-[1200px] relative shrink-0"
      data-name="EFMF feedback container"
    >
      <p className="font-['Sora:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#2c2c2c] text-[24px] md:text-[32px] tracking-[-0.5px] w-full">
...
function InternalStakeholderInterviewsContainer() {
  return (
    <div
      className="bg-white box-border content-stretch flex flex-col gap-[4px] items-start justify-center p-[16px] relative rounded-[8px] shrink-0"
      data-name="Internal stakeholder interviews container"
    >
      <div
        aria-hidden="true"
      ...
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] w-[min-content]">
        Recognized user behaviors, identified user pain points, and aligned on
        business objectives.
      </p>
    </div>
  );
...
function MarketResearchContainer() {
  ...
  return (
    <div
      className="bg-white box-border content-stretch flex flex-col gap-[4px] items-start justify-center p-[16px] relative rounded-[8px] shrink-0 w-full md:w-[618px]"
      data-name="Market research container"
    >
      <div
        aria-hidden="true"
        className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[8px]"
      />
      <p className="capitalize font-['Sora:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#2c2c2c] text-[16px] md:text-[18px] text-nowrap tracking-[-0.5px] whitespace-pre">
        💹 Market research
      </p>
...
function UxEvaluationContainer() {
  ...
  return (
    <div
      className="bg-white box-border content-stretch flex flex-col gap-[4px] items-start justify-center p-[16px] relative rounded-[8px] shrink-0 w-full md:w-[578px]"
      data-name="UX evaluation container"
    >
      <div
        aria-hidden="true"
        className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[8px]"
      ...
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#51596d] text-[0px] text-[16px] md:text-[18px] w-[min-content]">
        ...
        , user acquisition flows, and filing flow.
      </p>
      {showPricingImage && (
...
function ProductUsageAnalysisContainer() {
  return (
    <div
      className="bg-white box-border content-stretch flex flex-col gap-[4px] items-start justify-center p-[16px] relative rounded-[8px] shrink-0 w-full md:w-[547px]"
      data-name="Product usage analysis container"
    >
      <div
        aria-hidden="true"
        className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[8px]"
      ...
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] w-[min-content]">
        Partnered with developers to analyze product metrics, user behavior
        patterns, traffics, and feature adoption.
      </p>
    </div>
  );
}
...
function ComplianceResearchContainer() {
  ...
  return (
    <div
      className="bg-white box-border content-stretch flex flex-col gap-[4px] items-start justify-center p-[16px] relative rounded-[8px] shrink-0 w-full md:w-[693px]"
      data-name="Compliance research container"
    >
      <div
        aria-hidden="true"
        className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[8px]"
      ...
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#51596d] text-[0px] text-[16px] md:text-[18px] w-[min-content]">
        <span>{`Research `}</span>
        <span className="[text-underline-position:from-font] decoration-solid">
        ...
        , and the compliance landscape through official documentation,
...
function InsightsDetailsContainer() {
  return (
    <div
      ...
      data-name="Insights details container"
    >
...
function InsightsContainer() {
  return (
    <div
      className="bg-[#f9f8f7] box-border content-stretch flex flex-col gap-[16px] items-start w-full max-w-[1200px] px-[16px] md:px-[24px] py-[16px] relative rounded-[8px] shrink-0"
      data-name="Insights container"
    >
      <div
        aria-hidden="true"
        className="absolute border border-[#e6e3df] border-solid inset-0 pointer-events-none rounded-[8px]"
      />
      <p className="font-['Sora:Light',sans-serif] font-light leading-[normal] relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] text-nowrap tracking-[-0.5px] whitespace-pre">
...
function MainContainer() {
  return (
    <div
      className="bg-white box-border content-stretch flex flex-col gap-[40px] md:gap-[56px] items-center justify-center px-4 md:px-8 py-[48px] md:py-[64px] relative shrink-0 w-full"
...
function Header1() {
  return (
    <div
      className="content-stretch flex flex-col font-['Sora:Regular',sans-serif] font-normal gap-[8px] items-start leading-[normal] relative shrink-0 text-nowrap whitespace-pre w-full max-w-[1200px]"
      data-name="Header"
    >
      <p className="relative shrink-0 text-[#51596d] text-[16px] md:text-[18px]">
        🌟 Design highlights 1.
      </p>
      <p className="relative shrink-0 text-[#017780] text-[24px] md:text-[32px] tracking-[-0.5px]">
        Modernized branding
      </p>
    </div>
  );
...
function BeforeDesignItems() {
  return (
    <div
      className="box-border content-stretch flex gap-[16px] items-start overflow-x-auto px-px py-0 relative shrink-0"
      data-name="Before Design Items"
    >
      <div
        className="h-[687px] relative rounded-[8px] shadow-[0px_0px_0px_0.26px_rgba(0,0,0,0.23),0px_4.155px_12.466px_0px_rgba(0,0,0,0.35)] shrink-0 w-[600px] md:w-[800px]"
        data-name="OldEFMFHomePageBeforeLogin"
      >
        <img
          alt=""
      ...
      <div
        className="h-[687px] relative rounded-[8px] shadow-[0px_0px_0px_0.26px_rgba(0,0,0,0.23),0px_4.155px_12.466px_0px_rgba(0,0,0,0.35)] shrink-0 w-[600px] md:w-[800px]"
        data-name="OldEFMFHomePageAfterLogin"
      >
        <img
          alt=""
          className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[8px] size-full"
      ...
      <div
        className="h-[709px] relative rounded-[8px] shadow-[0px_0px_0px_0.26px_rgba(0,0,0,0.23),0px_4.155px_12.466px_0px_rgba(0,0,0,0.35)] shrink-0 w-[600px] md:w-[800px]"
        data-name="OldEFMFCartPage"
      >
        <img
          alt=""
          className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[8px] size-full"
      ...
      <div
        className="h-[575px] relative rounded-[8px] shadow-[0px_0px_0px_0.26px_rgba(0,0,0,0.23),0px_4.155px_12.466px_0px_rgba(0,0,0,0.35)] shrink-0 w-[600px] md:w-[800px]"
        data-name="OldEFMFOrderReviewPage"
      >
        <img
          alt=""
          className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[8px] size-full"
      ...
      <div
        className="h-[491px] relative rounded-[8px] shadow-[0px_0px_0px_0.26px_rgba(0,0,0,0.23),0px_4.155px_12.466px_0px_rgba(0,0,0,0.35)] shrink-0 w-[600px] md:w-[800px]"
        data-name="OldEFMFSignUpSuccessPage"
      >
        <img
          alt=""
          className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[8px] size-full"
...
function BeforeDesignSection() {
  return (
    <div
      ...
      data-name="Before Design Section"
    >
      <p className="font-['Sora:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#2c2c2c] text-[16px] md:text-[18.333px] text-nowrap tracking-[-0.2859px] whitespace-pre">
        Before my design
      </p>
      <BeforeDesignItems />
    </div>
...
function DesignSystemShowcase() {
  return (
    <div
      className="bg-[#f9f8f7] box-border content-stretch flex gap-[16px] md:gap-[24px] min-h-[400px] md:h-[772px] items-start p-[16px] md:p-[24px] relative rounded-[8px] shrink-0"
      data-name="Design system showcase"
    >
      <div
        aria-hidden="true"
        className="absolute border-[#e6e3df] border-[0.561px] border-solid inset-0 pointer-events-none rounded-[8px]"
      />
      <BeforeDesignSection />
    </div>
  );
...
function ContentContainer() {
  ...
  return (
    ...
    >
      <div
        className="h-auto lg:h-[772px] relative rounded-[8px] shrink-0 w-[1200px]"
        data-name="DesignSystemShowcaseImg"
      >
        <img
          alt=""
          className="relative inset-0 w-full h-full object-contain pointer-events-none rounded-[8px]"
...
function ProblemsSection() {
  return (
    <div
      className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0 tracking-[-0.5px]"
      data-name="Problems Section"
    >
      ...
      <ul className="block font-['Source_Sans_Pro:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#51596d] text-[0px] w-full list-disc">
        ...
        <li className="leading-[normal] ms-[calc(1.5*1*var(--list-marker-font-size,0))] text-[16px] md:text-[18px]">
          <span className="font-['Source_Sans_Pro:Regular',sans-serif] not-italic text-[#017780]">
...
function SolutionsItems() {
  return (
    <div
      className="basis-0 content-stretch flex flex-col grow items-end justify-between min-h-px min-w-px relative shrink-0"
      data-name="Solutions Items"
    >
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#51596d] text-[0px] text-[16px] md:text-[18px] tracking-[-0.5px] w-full">
        ...
        <span>{`that `}</span>will leave<span>{` a`}</span>n impression that is{" "}
        <span className="text-[#017780]">modern</span>
        <span>{`, `}</span>
      ...
      <p className="font-['Source_Sans_Pro:Italic',sans-serif] italic leading-[normal] relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] text-nowrap tracking-[-0.5px] whitespace-pre">
        Tax is already tedious. Why not make it more exciting? 😉
      </p>
      <div className="absolute h-[31px] left-[80px] top-[98.57px] w-[78px]">
        <div
          className="absolute inset-[-1.61%_-0.7%_-1.61%_-4.1%]"
          style={
            { "--stroke-0": "rgba(117, 117, 117, 1)" } as React.CSSProperties
          }
        >
          <svg
            className="block size-full"
          ...
          >
            <path
              d={svgPaths.p1c7d2980}
              fill="var(--stroke-0, #757575)"
              id="Vector 17"
            />
          </svg>
        </div>
...
function SolutionsSection() {
  return (
    <div
      className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative self-stretch shrink-0"
...
function ProblemsAndSolutionsSection() {
  return (
    <div
      className="content-stretch flex flex-col md:flex-row gap-[32px] md:gap-[56px] items-start relative shrink-0 w-full max-w-[1200px]"
      data-name="Problems and Solutions Section"
    >
      <ProblemsSection />
      <SolutionsSection />
    </div>
...
function MainContainer1() {
  return (
    <div
      className="bg-[#f5fffe] relative shrink-0 w-full h-full overflow-hidden"
      data-name="Main Container"
    >
      <div className="size-full">
...
function TextContainer() {
  return (
    <div
      className="content-stretch flex flex-col font-['Sora:Regular',sans-serif] font-normal gap-[8px] items-start leading-[normal] relative shrink-0 text-nowrap whitespace-pre"
...
function Container11() {
  return (
    <div
      className="content-stretch flex flex-col gap-[24px] md:gap-[32px] items-start relative shrink-0 w-full max-w-[1200px]"
      data-name="Container"
    >
      <TextContainer />
    </div>
...
function ProblemContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 tracking-[-0.5px]"
      data-name="Problem Container"
    >
...
function MainContainer2() {
  return (
    <div
      className="content-stretch flex flex-col gap-[24px] md:gap-[32px] items-start justify-center relative shrink-0 w-full max-w-[1200px]"
      data-name="Main Container"
    >
      <div
        className="w-full h-auto relative rounded-[8px] shrink-0"
        data-name="oldIANewCustomer"
      >
        <img
          alt=""
          className="relative inset-0 w-full h-auto object-contain pointer-events-none rounded-[8px]"
          src={imgOldIaNewCustomer}
        />
      </div>
      <div
        className="w-full h-auto relative rounded-[8px] shrink-0"
        data-name="oldIAExistingCustomer"
      >
        <img
          alt=""
          className="relative inset-0 w-full h-auto object-contain pointer-events-none rounded-[8px]"
...
function Container12() {
  return (
    <div
      className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full max-w-[1200px]"
      data-name="Container"
    >
      <ProblemContainer />
      <MainContainer2 />
...
function SolutionContainer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-nowrap tracking-[-0.5px]"
      data-name="Solution Container"
    >
      ...
      <ul className="[white-space-collapse:collapse] block font-['Source_Sans_Pro:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#51596d] text-[0px] list-disc">
        <li className="leading-[normal] mb-0 ms-[calc(1.5*1*var(--list-marker-font-size,0))] text-[16px] md:text-[18px]">
          ...
          <span>{`the `}</span>
          <span className="font-['Source_Sans_Pro:Regular',sans-serif] not-italic">{`purchase decision through tax filing with focused content and `}</span>
          clear
          <span className="font-['Source_Sans_Pro:Regular',sans-serif] not-italic">{` guidance at every step.`}</span>
        </li>
        <li className="leading-[normal] ms-[calc(1.5*1*var(--list-marker-font-size,0))] text-[16px] md:text-[18px]">
          <span className="text-[#017780]">
...
function Container13() {
  return (
    ...
    >
      ...
      <div
        className="w-full h-auto relative rounded-[8px] shrink-0"
        data-name="NewIAExistingCustomer"
      >
        <img
          alt=""
          className="relative inset-0 w-full h-auto object-contain pointer-events-none rounded-[8px]"
...
function Container15() {
  return (
    <div
      className="bg-[#f5fffe] relative shrink-0 w-full"
      data-name="Container"
    >
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] md:gap-[32px] items-center justify-center px-4 md:px-8 lg:px-16 py-[48px] md:py-[64px] relative w-full">
          <Header2 />
          <div
            className="w-full h-auto md:h-[938px] relative rounded-[8px] shrink-0 items-center justify-center max-w-[1200px]"
            data-name="global mdoernization strategy demo video"
          >
            <video
              autoPlay
              controls
              className="relative max-w-full h-auto md:h-full object-contain rounded-[8px]"
...
function Container16() {
  return (
    ...
    >
      ...
      <p className="relative shrink-0 text-[#017780] text-[24px] md:text-[32px] tracking-[-0.5px]">
        Single-step, guided signup to start with ease
      </p>
    </div>
  );
}
...
function Container18() {
  return (
    <div
      className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-[16px] md:text-[18px] tracking-[-0.5px]"
      data-name="Container"
    >
      ...
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#51596d] w-full">
        <span className="text-[#ff3030]">
          3-step signup with unnecessary data collection (18 data fields)
        </span>
...
function Container20() {
  return (
    <div
      className="basis-0 bg-white grow min-h-px min-w-[250px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0 h-full"
      data-name="Container"
    >
      <div className="min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col font-['Source_Sans_Pro:Regular',sans-serif] gap-[4px] items-start min-w-inherit not-italic px-[24px] py-[16px] relative text-[16px] md:text-[18px] w-full h-full">
          <p className="leading-[normal] relative shrink-0 text-[#017780] w-full">
            Removed 14 unused data fields
          </p>
          <div className="leading-[0] relative shrink-0 text-[#51596d] tracking-[-0.5px] w-full">
            <p className="leading-[normal]">
              Partnered with product, devs, and support to identify unused data
              and remove them from signup requirements.
            </p>
          </div>
        </div>
      </div>
...
function Container21() {
  return (
    <div
      className="basis-0 bg-white grow min-h-px min-w-[250px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0"
      data-name="Container"
    >
      <div className="min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col font-['Source_Sans_Pro:Regular',sans-serif] gap-[4px] items-start min-w-inherit not-italic px-[24px] py-[16px] relative text-[16px] md:text-[18px] w-full">
          ...
          <div className="leading-[0] relative shrink-0 text-[#51596d] tracking-[-0.5px] w-full">
            <p className="leading-[normal]">
              Customers can now create an account in a single screen,
              dramatically reducing abandonment and friction.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col font-['Source_Sans_Pro:Regular',sans-serif] gap-[4px] items-start min-w-inherit not-italic px-[24px] py-[16px] relative text-[16px] md:text-[18px] w-full">
          <p className="leading-[normal] relative shrink-0 text-[#017780] w-full">
            Mobile-responsive signup and login
          </p>
          <div className="leading-[0] relative shrink-0 text-[#51596d] tracking-[-0.5px] w-full">
            <p className="leading-[normal]">
              Recognizing high mobile signup volume, the redesigned flow is now
              responsive, allowing users to sign up from anywhere without
              friction.
            </p>
          </div>
        </div>
  ...
  return (
    ...
    >
      <div className="min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col font-['Source_Sans_Pro:Regular',sans-serif] gap-[4px] items-start min-w-inherit not-italic px-[24px] py-[16px] relative text-[16px] md:text-[18px] w-full">
          <p className="leading-[normal] relative shrink-0 text-[#017780] w-full">
            Better product insights via new URL architecture
          </p>
          <div className="leading-[0] relative shrink-0 text-[#51596d] tracking-[-0.5px] w-full">
            <p className="leading-[normal]">
              Unique URLs for each step provided product and marketing teams
              with visibility into where users drop off, empowering data-driven
              improvements.
            </p>
          </div>
        </div>
...
function Container26() {
  return (
    ...
    >
      <Container25 />
      <div
        className="w-full h-auto relative shrink-0"
        data-name="NewSignupDesign"
      >
...
function ProblemContent() {
  return (
    <div
      className="content-stretch flex flex-col md:flex-row gap-[16px] items-start relative shrink-0 w-full"
      data-name="Problem Content"
    >
      <div
        className="basis-0 grow min-h-px min-w-px relative rounded-[8px] shrink-0 w-full"
        data-name="OldEFMFCartPageAddOn"
      >
        <img
          alt=""
          className="relative inset-0 w-full h-auto object-contain pointer-events-none rounded-[8px]"
      ...
      <div
        className="basis-0 grow min-h-px min-w-px relative rounded-[8px] shrink-0 w-full"
        data-name="OldEFMFOrderReviewPageDelayProcessing"
      >
        <img
          alt=""
          className="relative inset-0 w-full h-auto object-contain pointer-events-none rounded-[8px]"
...
function SolutionColumn() {
  return (
    <div
      className="basis-0 bg-white grow min-h-[128px] min-w-[250px] relative rounded-[8px] shadow-[-1px_-1px_8px_1.9px_rgba(173,195,248,0.12),2px_3.467px_8px_1.9px_rgba(173,195,248,0.12)] shrink-0"
      data-name="Solution Column"
    >
      <div className="min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col font-['Source_Sans_Pro:Regular',sans-serif] gap-[4px] items-start min-w-inherit not-italic px-[24px] py-[16px] relative text-[16px] md:text-[18px] w-full">
          <p className="leading-[normal] relative shrink-0 text-[#017780] w-full">
            Surfaced add-ons in order review
          </p>
          <div className="leading-[0] relative shrink-0 text-[#51596d] tracking-[-0.5px] w-full">
  ...
  return (
    ...
    >
      <div className="min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col font-['Source_Sans_Pro:Regular',sans-serif] gap-[4px] items-start min-w-inherit not-italic px-[24px] py-[16px] relative text-[16px] md:text-[18px] w-full">
          <p className="leading-[normal] relative shrink-0 text-[#017780] w-full">
            Redesigned delay processing options
          </p>
          <div className="leading-[0] relative shrink-0 text-[#51596d] tracking-[-0.5px] w-full">
            <p className="leading-[normal]">
              Replaced confusing technical descriptions with clear, friendly
              content, and added conditional prompts that explain when
              processing should start to allow time for TINCheck.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col font-['Source_Sans_Pro:Regular',sans-serif] gap-[4px] items-start min-w-inherit not-italic px-[24px] py-[16px] relative text-[16px] md:text-[18px] w-full">
          <p className="leading-[normal] relative shrink-0 text-[#017780] w-full">
            Celebrated purchase milestones
          </p>
          <div className="leading-[0] relative shrink-0 text-[#51596d] tracking-[-0.5px] w-full">
            <p className="leading-[normal]">
              Redesigned Order Received page to acknowledge the order and
              provide clear guidance on next steps. This reduces post-purchase
              anxiety and decreases support ticket volume.
            </p>
          </div>
        </div>
      </div>
    ...
    >
      <div className="min-h-inherit min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col font-['Source_Sans_Pro:Regular',sans-serif] gap-[4px] items-start min-h-inherit min-w-inherit not-italic px-[24px] py-[16px] relative text-[16px] md:text-[18px] w-full">
          ...
          <div className="leading-[0] relative shrink-0 text-[#51596d] tracking-[-0.5px] w-full">
            <p className="leading-[normal]">
              Partnered with legal and marketing to consolidate terms of service
              and move the acceptance checkbox from checkout to signup.
            </p>
          </div>
        </div>
      </div>
...
function SolutionSection() {
  return (
    <div
      className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full max-w-[1200px]"
      data-name="Solution Section"
    >
      <SolutionTitle />
      <div
        className="w-full h-auto relative shrink-0"
        data-name="checkoutRedesign"
      >
        <img
          alt=""
          className="relative inset-0 w-full h-auto object-contain pointer-events-none"
...
function Container28() {
  return (
    <div
      className="basis-0 content-stretch flex flex-col gap-[24px] md:gap-[40px] grow items-start min-h-px min-w-px relative shrink-0"
      data-name="Container"
    >
      <div className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#51596d] text-[0px] tracking-[-0.5px] w-full">
        <p className="leading-[normal] mb-0 text-[16px] md:text-[18px] whitespace-pre-wrap">
          <span className="font-['Source_Sans_Pro:Regular',sans-serif] not-italic">{`In 4 months, we delivered the phase 1 redesign - a design MVP.  5 months later, we delivered the phase 2 - the checkout experience upgrade. In total, we redesigned 50+ pages with many major experience improvements, all within tight timeline and resource constraints. This is unprecedented at Sovos, especially for a newly formed team`}</span>
          .
          <span className="font-['Source_Sans_Pro:Regular',sans-serif] not-italic">
            {" "}
          </span>
        </p>
        <p className="leading-[normal] mb-0 text-[16px] md:text-[18px]">
          &nbsp;
        </p>
        <p className="leading-[normal] mb-0 text-[16px] md:text-[18px]">
          Customers reacted positively to this release, and the business metrics
          reflected it:
        </p>
        <ul className="list-disc ml-[-1.5em] mb-0">
          <li className="leading-[normal] ms-[27px] text-[16px] md:text-[18px]">
            <span className="leading-[normal] text-[16px] md:text-[18px]">
              glowing reviews
            </span>
          </li>
          <li className="leading-[normal] ms-[27px] text-[16px] md:text-[18px]">
            <span className="leading-[normal] text-[16px] md:text-[18px]">
              NPS: 15-point increase
            </span>
          </li>
          <li className="leading-[normal] ms-[27px] text-[16px] md:text-[18px]">
            <span className="leading-[normal] text-[16px] md:text-[18px]">
          ...
          <li className="leading-[normal] ms-[27px] text-[16px] md:text-[18px]">
            <span className="font-['Source_Sans_Pro:Regular',sans-serif] not-italic">{`and... `}</span>
            overwhelmed server due to popularity
            <span className="font-['Source_Sans_Pro:Regular',sans-serif] not-italic">{` (a good problem to have 😉)`}</span>
          </li>
        </ul>
        <p className="leading-[normal] mb-0 text-[16px] md:text-[18px]">
          &nbsp;
...
function Container29() {
  return (
    <div
      className="content-stretch flex flex-col md:flex-row gap-[24px] md:gap-[40px] items-start relative shrink-0 w-full"
      data-name="Container"
    >
      <Container28 />
      <div
        className="w-full md:w-auto h-auto md:h-[328px] relative rounded-[4px] shadow-[0px_4.938px_14.815px_0px_rgba(0,0,0,0.35)] shrink-0 md:shrink"
        data-name="redditEFMFpost"
      >
        <img
          alt=""
          className="relative inset-0 w-full h-auto md:w-[359px] md:h-[328px] object-contain pointer-events-none rounded-[4px]"
...
function InsightGroup2() {
  return (
    <div
      ...
      data-name="Insight group"
    >
      <p className="font-['Sora:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#017780] text-[20px] md:text-[24px] w-full">
  ...
  return (
    ...
    >
      <div className="basis-0 font-['Source_Sans_Pro:Regular',sans-serif] grow leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[#51596d] text-[16px] md:text-[18px] tracking-[-0.5px]">
        <p className="mb-0">
          In the beginning, we felt unsure if we could accomplish so much with
          limited resources and a fully remote team. In addition, some of the
          code and infrastructure were ancient and untouchable. We had to
          abandon progress and design last-minute alternatives due to unexpected
          technical issues.
        </p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">
          Because of the complexity of tax filing, every design decision
          required approval from marketing, legal, product, content, and
          support.
        </p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">
          To ensure timely delivery and a smooth experience across the entire
          user journey, I wore many hats, including: product owner, QA engineer,
          product manager, developer and manage projects like: emails, back
          office management, and marketing messaging. Coding dark mode for
          product emails was a pain...
        </p>
        <p className="mb-0">&nbsp;</p>
        <p>
          By actively listening, learning from each other, and working to find
          solutions, we grew close and accomplished a lot together. When release
          dates approached, we were hands-on-deck supporting the launch
          together. When pizza day and Halloween came around, we celebrated and
          pranked each other.
        </p>
      </div>
      <div
        className="basis-0 grow min-h-px min-w-px relative shadow-[-1px_-1px_8px_1.9px_rgba(134,120,72,0.12),2px_3.467px_8px_1.9px_rgba(134,120,72,0.12)] shrink-0 w-full md:w-auto"
        data-name="EFMF Pizza party"
      >
        <img
          alt=""
          className="relative inset-0 w-full h-auto object-contain pointer-events-none"
...
function Container31() {
  return (
    <div
      className="box-border content-stretch flex items-center justify-between overflow-x-auto gap-[16px] md:gap-0 pl-0 pr-0 md:pr-[115px] py-0 relative rounded-[8px] shrink-0 w-full"
      data-name="Container"
    >
      <div
        className="h-auto md:h-[285.104px] mr-0 md:mr-[-115px] relative rounded-[8px] shadow-[0px_0px_0px_0.26px_rgba(0,0,0,0.23),0px_4.155px_12.465px_0px_rgba(0,0,0,0.35)] shrink-0 w-[250px] md:w-[389.55px]"
        data-name="EFMFMKT"
      >
        <img
          alt=""
...
function Container33() {
  return (
    <div
      className="content-stretch flex flex-col gap-[32px] md:gap-[40px] items-start relative shrink-0 w-full max-w-[1200px]"
      data-name="Container"
    >
      <p className="font-['Sora:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#2c2c2c] text-[24px] md:text-[32px] tracking-[-0.5px] w-full">
        How did it turn out?
...
function Footer() {
  return (
    <div
      className="content-stretch flex flex-col gap-[10px] items-center justify-center px-4 relative shrink-0 w-full"
      data-name="Footer"
    >
...
function MainFrame() {
  return (
    <div
      className="relative bg-white box-border content-stretch flex flex-col items-center justify-center pb-[56px] pt-0 px-0 w-full overflow-visible"
...
function Logo() {
  return (
    <Link
      to="/"
      className="content-stretch flex font-['Sora:Bold',sans-serif] font-bold gap-[2px] items-center leading-[normal] relative shrink-0 text-[#09543d] text-[18px] md:text-[20px] text-nowrap tracking-[-0.2px] uppercase whitespace-pre cursor-pointer"
      data-name="Logo"
    >
...
function NavBar() {
  return (
    <div
      className="sticky box-border content-stretch flex items-center justify-between left-0 px-4 md:px-[32px] py-[24px] top-0 w-full z-50"
      data-name="NavBar"
    >
