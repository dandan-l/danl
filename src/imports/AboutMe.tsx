    ...
    >
      <div className="absolute inset-[-0.14%_-1.88%_-2.5%_-2.65%]">
        ...
        >
          <g id="design-doodle">
            <path
              d={svgPaths.p383ce100}
              id="Vector 83"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            <path
              d={svgPaths.p1e401fc0}
              id="Vector 84"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            <path
              d={svgPaths.p1052c980}
              id="Vector 85"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
    ...
    >
      <div className="absolute inset-[-2.5%_-2.75%]">
        ...
        >
          <g id="about-doodle">
            <path
              d={svgPaths.p34b14d00}
              id="Vector 140"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            <path
              d={svgPaths.p27932d00}
              id="Vector 141"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            <path
              d={svgPaths.p20f40a80}
              id="Vector 142"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            <path
              d={svgPaths.p39191b80}
              id="Vector 143"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            ...
            />
            <path
              d={svgPaths.p2df37800}
              id="Vector 149"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            <path
              d={svgPaths.p38120b80}
              id="Vector 150"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            ...
            />
            <path
              d={svgPaths.p187a45c8}
              id="Vector 154"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            <path
              d={svgPaths.p3b38f100}
              id="Vector 155"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
      ...
      <div className="absolute inset-[-2.86%_-3.96%]">
        ...
        >
          <g id="Resume-doodle">
            ...
            />
            <path
              d={svgPaths.p17c9c480}
              id="Vector 177"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            <path
              d={svgPaths.p3f34af00}
              id="Vector 178"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            <path
              d={svgPaths.p37216380}
              id="Vector 179"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
      ...
      <div className="absolute inset-[-3.13%_-2.04%_-3.12%_-2.04%]">
        ...
        >
          <g id="contact-doodle">
            ...
            />
            <path
              d={svgPaths.p2bee3b80}
              id="Vector 162"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
            <path
              d={svgPaths.p10fb7780}
              id="Vector 163"
              stroke="var(--stroke-0, #09543D)"
              strokeLinecap="round"
            />
...
function NavBar() {
  return (
    <div
      className="sticky box-border content-stretch flex items-center justify-between left-0 px-[32px] py-[24px] top-0 w-full max-w-[1440px] mx-auto z-50"
      data-name="Nav bar"
    >
