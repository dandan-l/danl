...
export function ProjectButton() {
  ...
  return (
    ...
    >
          ...
          >
            <g id="design-doodle">
              <path
                ...
                id="Vector 83"
                stroke={isHovered ? "#09543D" : "#09543D"}
                strokeLinecap="round"
              />
              <path
              ...
              <path
                ...
                id="Vector 89"
                stroke={isHovered ? "#FECA05" : "#09543D"}
                strokeLinecap="round"
                strokeWidth={isHovered ? "1.25003" : "1"}
              />
              <path
      ...
      <p
        className={`font-['Sora:Bold',_sans-serif] font-bold leading-[normal] relative shrink-0 text-[16px] text-nowrap tracking-[-0.2px] whitespace-pre transition-colors ${
          isHovered ? "text-[#feca05]" : "text-[#09543d]"
        }`}
      >
        projects
      </p>
              ...
              {isHovered && (
                <>
                  ...
                  <g transform="translate(6.65, 7.5)">
                    <path
                      d={svgPathsHover.p3972c300}
                      stroke="#FECA05"
                      strokeLinecap="round"
                      strokeWidth="0.762489"
                    />
                    <path
                      d={svgPathsHover.p3bb6db80}
                      stroke="#FECA05"
                      strokeLinecap="round"
                      strokeWidth="0.62499"
                    />
                    <path
                      d={svgPathsHover.p2e35a180}
                      stroke="#FECA05"
                      strokeLinecap="round"
                      strokeWidth="0.62499"
                    />
                    <path
                      d={svgPathsHover.p3be1e00}
                      stroke="#FECA05"
                      strokeLinecap="round"
                      strokeWidth="0.62499"
                    />
                    <path
                      d={svgPathsHover.p3c451500}
                      stroke="#FECA05"
                      strokeLinecap="round"
                      strokeWidth="0.62499"
                    />
                    <path
                      d={svgPathsHover.p115b2a20}
                      stroke="#FECA05"
                      strokeLinecap="round"
                      strokeWidth="0.62499"
                    />
                  ...
                  <g transform="translate(11.5, 7.3)">
                    <path
                      d={svgPathsHover.pb695000}
                      stroke="#FECA05"
                      strokeLinecap="round"
                      strokeWidth="0.762489"
                    />
                    <path
                      d={svgPathsHover.p37850400}
                      stroke="#FECA05"
                      strokeLinecap="round"
                      strokeWidth="0.62499"
                    />
                    <path
                      d={svgPathsHover.p3c8dde00}
                      stroke="#FECA05"
                      strokeLinecap="round"
                      strokeWidth="0.62499"
                    />
                    <path
                      d={svgPathsHover.p3fbd0100}
                      stroke="#FECA05"
                      strokeLinecap="round"
                      strokeWidth="0.62499"
                    />
              ...
              {isHovered && (
                <>
                  ...
                  <g transform="translate(3.5, 10.5)">
                    ...
                    />
                    <path
                      d={svgPathsHover.p15942380}
                      stroke="#09543D"
                      strokeLinecap="round"
                    />
                    <path
                      d={svgPathsHover.p18b15c00}
                      stroke="#09543D"
                      strokeLinecap="round"
                    />
                    <path
                      d={svgPathsHover.p1932ad80}
                      stroke="#09543D"
                      strokeLinecap="round"
                    />
                  </g>
              ...
              {isHovered && (
                <>
                  ...
                  <g transform="translate(2.45, 3.1)">
                    <path
                      d={svgPathsContact.p30969500}
                      stroke="white"
                      strokeLinecap="round"
                      strokeWidth="0.571437"
                    />
                  </g>
                  ...
                  <g transform="translate(21.5, 11)">
                    <path
                      d={svgPathsContact.pde15180}
                      stroke="white"
                      strokeLinecap="round"
                      strokeWidth="0.571437"
                    />
                    <path
                      d={svgPathsContact.p2d098e00}
                      stroke="white"
                      strokeLinecap="round"
                      strokeWidth="0.571437"
                    />
