      ...
      <div className="efmf-prototype-container">
        ...
        <div className="efmf-prototype-image-wrapper">
          <img 
            ...
            alt="Prototype review session showing design collaboration and feedback process for eFileMyForms redesign"
            className="efmf-prototype-image"
          />
        </div>
        ...
        <div className="efmf-branding-grid">
          <div className="efmf-branding-card">
            ...
            <div className="efmf-branding-callouts">
              <div className="efmf-branding-callout">
                <h4 className="efmf-branding-callout-title">Resource constraints</h4>
              ...
              <div className="efmf-branding-callout">
                <h4 className="efmf-branding-callout-title">Technical constraints</h4>
                <p className="efmf-branding-callout-description">
          ...
          <div className="efmf-branding-card">
            ...
            <div className="efmf-branding-callouts">
              <div className="efmf-branding-callout">
                <h4 className="efmf-branding-callout-title">Phased modernization strategy</h4>
                <p className="efmf-branding-callout-description">
                  Partnered with products and developers to create phased modernization strategy that achieved visual transformation without extensive effort. By breaking work into focused phases - <strong>global nav/footer</strong> → <strong>distraction cleanup</strong> → <strong>fonts/tables</strong> - and leveraging CSS modifications to existing components, each release delivered instant user value while minimizing development scope and technical risk. 
                </p>
              </div>
            </div>
          </div>
